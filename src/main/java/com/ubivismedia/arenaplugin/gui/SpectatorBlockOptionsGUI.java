...
public class SpectatorBlockOptionsGUI {
    
    private final Arena arena;
    private final Block configBlock;
    private final Inventory gui;
    
    public SpectatorBlockOptionsGUI(Arena arena, Block configBlock) {
        this.arena = arena;
        this.configBlock = configBlock;
        this.gui = Bukkit.createInventory(null, 9, "Zuschauerblock-Einstellungen");
        setupItems();
    }
    ...
    public void handleClick(InventoryClickEvent event) {
        ...
        switch (slot) {
            case 0:
                arena.toggleSpectatorBlockVisibility(configBlock);
                player.sendMessage("Sichtbarkeit des Zuschauerblocks geändert!");
                break;
            case 1:
